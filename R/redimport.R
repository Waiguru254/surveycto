...
library(redcapAPI)
library(dplyr)
redimport<- function (token, url, form_name) {
                      ...
                      data_dictionary <- suppressWarnings(redcap_dic %>%
                      ...
                      data_mul <- suppressWarnings(redcap_dic %>%
                            janitor:: clean_names() %>%
                            ### Removing rows without valeu labels 
                            ...
                            odkshrink<- function(ColName, data, remove=TRUE) {
                            ...
                            xv<-paste("data<-odkshrink('",checkbox_col,"',data)",sep="")
                            ...
                            data<- data %>% dplyr::select(cols_on)
